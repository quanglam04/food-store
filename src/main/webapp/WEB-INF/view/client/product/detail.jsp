            ...
            <div class="row g-4">
              ...
              <div class="col-lg-6">
                ...
                <h5 class="text-dark fs-5 fw-bold mb-0">
                  <fmt:formatNumber type="number" value="${prd.price}" /> vnd/
                  ${prd.unit}
                </h5>
              ...
              <div class="col-lg-12">
                ...
                <div class="tab-content mb-5">
                  ...
                  >
                    <p>Nguồn gốc xuất xứ: ${prd.source}</p>
                    <p>${prd.detailDesc}</p>
                  </div>
                  <div
                    class="tab-pane"
                  ...
                  >
                    <div class="d-flex">
                      ...
                      <div class="">
                        ...
                        <p>
                          Ngon bổ, rẻ uy tín nhé mọi người. Mình đã mua 5 lần ở
                          đây rồi, lần nào cũng rất hài lòng.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="mb-4">
                  ...
                  <ul class="list-unstyled fruite-categorie">
                    ...
                    <li>
                      <div class="d-flex justify-content-between fruite-name">
                        <a href="#"
                          ><i class="fas fa-apple-alt me-2"></i>Trái cây</a
                        >
                        <span>(${number_3})</span>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex justify-content-between fruite-name">
                        <a href="#"
                          ><i class="fas fa-egg me-2"></i>Thực phẩm giàu
                          protein</a
                        >
                        <span>(${number_4})</span>
                      </div>
                    ...
                    <li>
                      <div class="d-flex justify-content-between fruite-name">
                        <a href="#"
                          ><i class="fas fa-bread-slice me-2"></i>Thực phẩm chứa
                          tinh bột</a
                        >
                        <span>(${number_6})</span>
                      </div>
                    ...
                    <li>
                      <div class="d-flex justify-content-between fruite-name">
                        <a href="#"
                          ><i class="fas fa-wine-bottle me-2"></i>Thức uống</a
                        >
                        <span>(${number_5})</span>
                      </div>
                    </li>
          ...
          <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
              ...
              >
                ...
                >
                  Thực phẩm tươi sạch
                </div>
                <div class="p-4 rounded-bottom">
                  <h4>Rau mùi</h4>
                  <p>Mùi tây tươi xanh chất lượng cao từ vườn.</p>
              ...
              >
                ...
                <div class="p-4 rounded-bottom">
                  <h4>Chuối</h4>
                  <p>Chuối vàng chín mọng giàu dinh dưỡng.</p>
                  <div class="d-flex justify-content-between flex-lg-wrap">
              ...
              >
                ...
                <div class="p-4 rounded-bottom">
                  <h4>Ớt chuông</h4>
                  <p>Ớt chuông đỏ tươi, giòn ngọt và giàu vitamin.</p>
                  <div class="d-flex justify-content-between flex-lg-wrap">
              ...
              >
                ...
                <div class="p-4 rounded-bottom">
                  <h4>Khoai tây</h4>
                  <p>Khoai tây tươi ngon từ nông trại, giàu dinh dưỡng.</p>
                  <div class="d-flex justify-content-between flex-lg-wrap">
              ...
              >
                <div class="vesitable-img">
                  <img
                    src="/client/img/best-product-1.jpeg"
                    class="img-fluid w-100 rounded-top"
                    alt=""
                  />
                </div>
                ...
                <div class="p-4 rounded-bottom">
                  <h4>Cam</h4>
                  <p>
                    Cam tươi mọng nước, cung cấp vitamin C giúp tăng cường hệ
                    miễn dịch.
                  </p>
                  <div class="d-flex justify-content-between flex-lg-wrap">
              ...
              >
                <div class="vesitable-img">
                  <img
                    src="/client/img/best-product-6.jpeg"
                    class="img-fluid w-100 rounded-top"
                    alt=""
                  />
                </div>
